  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Investment Projects</h1>
          <p className="text-gray-500 text-xs sm:text-sm">Manage fundraising projects for investors.</p>
        </div>
        <button 
          onClick={() => {
            setEditingProject(null);
